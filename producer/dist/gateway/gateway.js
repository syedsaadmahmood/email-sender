...
let MyGateWay = exports.MyGateWay = class MyGateWay {
    findAll(data) {
        console.log('Socket Connected on Client and this is the message ==> ', data);
        return (0, rxjs_1.from)([1, 2, 3]).pipe((0, rxjs_1.map)((item) => ({ event: 'events', data: item })));
    }
    emitEmailSentEvent(data) {
    ...
    onEmailSent(body) {
        console.log('Socket Email Sent from BackEnd Viewing in backend is here ==> ', body);
    }
};
__decorate([
...
], MyGateWay.prototype, "findAll", null);
__decorate([
...
__decorate([
    (0, websockets_1.SubscribeMessage)('emailSent'),
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], MyGateWay.prototype, "onEmailSent", null);
